from motion_planning import RandomWorld, plot_world
from motion_planning.planners import RRTStarPlanner


def main() -> None:
    # Create a random 3D world with obstacles.
    ...
    # Run RRT* with rewiring for better path quality.
    planner = RRTStarPlanner(step_size=0.6, max_iters=2500, goal_sample_rate=0.08)
